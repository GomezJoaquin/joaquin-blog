...
<html data-n-head-ssr>
  ...
  <body>
    <div data-server-rendered="true" id="__nuxt"><!----><div id="__layout"><div><div class="flex flex-col min-h-screen w-full bg-white dark:bg-gray-900" data-v-0350a212><div class="flex flex-col px-4 sm:px-8 md:px-16 lg:px-24 py-12 text-center" data-v-0350a212><a href="/joaquin-blog/" class="flex items-center text-gray-800 dark:text-gray-100 mb-8 hover:text-blue-600 dark:hover:text-blue-400 hover:underline nuxt-link-active" data-v-0350a212><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" width="24" class="mr-2 group-hover:translate-x-[-2px] transition-transform" data-v-0350a212><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" data-v-0350a212></path></svg>
      ...
      javascript
    </h1> <p class="text-lg text-gray-700 dark:text-gray-300 mb-8" data-v-0350a212>JavaScript is a programming language adhering to the ECMAScript spec.</p> <div class="prose dark:prose-dark mx-auto mb-12 nuxt-content" data-v-0350a212 data-v-0350a212></div> <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-10" data-v-0350a212>
      Artículos sobre javascript
    </h2> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" data-v-0350a212></div></div></div></div></div></div><script defer src="/joaquin-blog/_nuxt/static/1719729370/blog/tag/javascript/state.js"></script><script src="/joaquin-blog/_nuxt/d94a2b9.js" defer></script><script src="/joaquin-blog/_nuxt/fa9847c.js" defer></script><script src="/joaquin-blog/_nuxt/1516c12.js" defer></script><script src="/joaquin-blog/_nuxt/4df6245.js" defer></script><script src="/joaquin-blog/_nuxt/c03a38e.js" defer></script>
  </body>
</html>
