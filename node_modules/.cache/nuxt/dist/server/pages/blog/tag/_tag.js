...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/tag/_tag.vue?vue&type=template&id=52bace36
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "flex lg:h-screen w-screen lg:overflow-hidden xs:flex-col lg:flex-row"
  }, [_vm._ssrNode("<div class=\"relative lg:w-1/2 xs:w-full xs:h-84 lg:h-full post-left\"><img" + _vm._ssrAttr("src", _vm.tag.img) + _vm._ssrAttr("alt", _vm.tag.name) + " class=\"absolute h-full w-full object-cover\"></div> <div class=\"overlay\"></div> "), _vm._ssrNode("<div class=\"absolute top-32 left-32 right-32 text-white\">", "</div>", [_c('NuxtLink', {
    attrs: {
      "to": "/"
    }
  }, [_c('Logo')], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"mt-16 -mb-3 flex flex-col text-sm\">", "</div>", [_vm._ssrNode("<div class=\"relative lg:w-1/2 xs:w-full xs:h-84 lg:h-full post-left\">", "</div>", [_vm._ssrNode("<h1 class=\"text-4xl font-bold uppercase\">" + _vm._ssrEscape("\n          " + _vm._s(_vm.tag.name) + "\n        ") + "</h1> <p class=\"mb-4 uppercase\">" + _vm._ssrEscape(_vm._s(_vm.tag.description)) + "</p> "), _c('nuxt-content', {
    attrs: {
      "document": _vm.tag
    }
  })], 2)])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"relative xs:py-8 xs:px-8 lg:py-32 lg:px-16 lg:w-1/2 xs:w-full h-full overflow-y-scroll markdown-body post-right custom-scroll\">", "</div>", [_c('NuxtLink', {
    attrs: {
      "to": "/"
    }
  }, [_c('p', {
    staticClass: "hover:underline"
  }, [_vm._v("Regresar a todos los articulos")])]), _vm._ssrNode(" <h3 class=\"mb-4 font-bold text-4xl\">" + _vm._ssrEscape("Articles tagged " + _vm._s(_vm.tag.name) + ":") + "</h3> "), _vm._ssrNode("<ul>", "</ul>", _vm._l(_vm.articles, function (article) {
...
// CONCATENATED MODULE: ./pages/blog/tag/_tag.vue?vue&type=template&id=52bace36
