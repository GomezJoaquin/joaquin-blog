...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/blog/_slug.vue?vue&type=template&id=65c6fd45
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100"
  }, [_vm._ssrNode("<div class=\"container mx-auto px-4 py-8\">", "</div>", [_vm._ssrNode("<div class=\"flex justify-center\">", "</div>", [_vm._ssrNode("<div class=\"w-full lg:w-3/4\">", "</div>", [_vm._ssrNode("<h1 class=\"text-3xl lg:text-4xl font-bold mb-4\">" + _vm._ssrEscape(_vm._s(_vm.article.title)) + "</h1> "), _vm._ssrNode("<div class=\"flex items-center mb-4 text-sm text-gray-500 dark:text-gray-400\">", "</div>", [_vm._ssrNode("<p>" + _vm._ssrEscape(_vm._s(_vm.formatDate(_vm.article.updatedAt))) + "</p> <span class=\"mx-2\">•</span> "), _vm._l(_vm.article.tags, function (tag, id) {
    return _vm._ssrNode("<span class=\"px-3 py-1 mr-2 mb-2 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs\">", "</span>", [_c('router-link', {
      attrs: {
        "to": `/blog/tag/${_vm.tags[tag].slug}`
      }
    }, [_vm._v(_vm._s(_vm.tags[tag].name))])], 1);
  })], 2), _vm._ssrNode(" <p class=\"text-base mb-4\">" + _vm._ssrEscape(_vm._s(_vm.article.description)) + "</p> <p class=\"text-xs text-gray-500 dark:text-gray-400 mb-4\">" + _vm._ssrEscape("Última actualización: " + _vm._s(_vm.formatDate(_vm.article.updatedAt))) + "</p> "), _vm._ssrNode("<nav class=\"mb-6\">", "</nav>", [_vm._ssrNode("<ul>", "</ul>", _vm._l(_vm.article.toc, function (link) {
...
// CONCATENATED MODULE: ./pages/blog/_slug.vue?vue&type=template&id=65c6fd45
